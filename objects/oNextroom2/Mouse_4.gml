...
var vist2 = oRifle.visited = true && oStorefront.visited = true && oBattries.visited = true && oPoster.visited = true;

if (vist2 = true && instance_exists(obj_scribbleTextbox) == false){
//turns off layers 
...
} else if (vist2 = false && instance_exists(obj_scribbleTextbox) == false){
	//turns off layers 
	layer_set_visible("Info_layer", false);
	layer_set_visible("tint", false);
	layer_set_visible("textbox", false);
